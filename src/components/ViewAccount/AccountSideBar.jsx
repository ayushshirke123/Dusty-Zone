        ...
        <div className="view-account-left">
            <div className="left-account-div-main">
                <div className="user-account-img-main">
                    <div className="user-account-img">{loginInfo?.name?.charAt(0)}</div>
                </div>
                <div className="user-greeting-text"><Link className='user-greeting-text' to='/view-account'>{users?.name}</Link></div>
